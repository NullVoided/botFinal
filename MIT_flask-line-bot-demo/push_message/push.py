...
for i in e1:
    line_bot_api.push_message(i, TextSendMessage(text='ALERT!!! \nHello emergency contact of Lucia, Please be advised that Lucia has an EMERGENCY and the medical personnel are currently on their way to his location. \nPlease wait while we confirm her hospital\'s location.'))
time.sleep(120)
for i in e1:
    line_bot_api.push_message(i, TextSendMessage(text='Please visit her at https://goo.gl/maps/81TPsg4hH3Yw4K1p7'))
