...
def message_text(event):
    ...
    #visualisation
    with open('Lucia.csv', 'a', newline='') as csvfile:
    ...
    line_bot_api.reply_message(
        event.reply_token,
        TextSendMessage(text="Hello Ms Lucia, Your prescription for NovoLog Insulin aspart Injection 10mL will be delivered to your address in 4 days")
    )
